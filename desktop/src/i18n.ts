...
const namedMessages = {
  en: {
    ...
    'listings.guide.reality1': 'Only published and currently available marketplace Listings can be purchased. An account may also purchase its own API for testing or internal use.',
  ...
  zh: {
    ...
    'listings.guide.reality1': '\u53ea\u80fd\u8d2d\u4e70\u5df2\u53d1\u5e03\u4e14\u5f53\u524d\u53ef\u7528\u7684\u5e02\u573a Listing\u3002\u8d26\u6237\u4e5f\u53ef\u4ee5\u8d2d\u4e70\u81ea\u5df1\u53d1\u5e03\u7684 API\uff0c\u7528\u4e8e\u6d4b\u8bd5\u6216\u5185\u90e8\u4f7f\u7528\u3002',
...
Object.assign(phraseTranslations, {
  ...
  'Fallback terms used when the provider prepares a quote': '提供方准备报价时使用的兜底条款',
  'ETA seconds': '预计秒数',
  ...
  'When this provider can accept work.': '此提供方可接受工作的时间。',
  ...
  'Mirrors the provider quote policy.': '与提供方的报价策略保持一致。',
  'Mirrors the provider low-risk acceptance policy.': '与提供方的低风险接受策略保持一致。',
  ...
  'Provider settings saved.': '提供方设置已保存。',
